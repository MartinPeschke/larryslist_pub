...
from larryslist.admin.apps.collector.collections_forms import BaseCollectionForm
...
class CreateHandler(BaseCollectorHandler):
    ...
    def isFormEnabled(self, form):
        return self.forms[0].id == form.id
...
class CollectionCreateForm(CreateHandler):
