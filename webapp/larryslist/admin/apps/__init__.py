...
ROUTE_LIST = [
    ...
    , ClassRoute("admin_collection_create", "/collection/create/:collectorId", contexts.AdminRootContext, collector.CollectionCreate, "collector/create.html", view_attrs=JSON_FORM_ATTRS)
    , ClassRoute("admin_collection_edit", "/collection/edit/:collectorId/:stage", contexts.AdminRootContext, collector.CollectionEdit, "collector/create.html", view_attrs=JSON_FORM_ATTRS)
]
