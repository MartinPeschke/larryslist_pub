...
ROUTE_LIST = [
    ...
    , ClassRoute("admin_collector_edit", "/collector/edit/:collectorId/:stage", contexts.AdminRootContext, collector.EditHandler, "collector/create.html", view_attrs=JSON_FORM_ATTRS)
    , ClassRoute("admin_collection_create", "/collection/create/:collectorId", contexts.AdminRootContext, collector.CollectionCreateForm, "collector/create.html", view_attrs=JSON_FORM_ATTRS)
    , ClassRoute("admin_collection_edit", "/collection/edit/:collectionId/:stage", contexts.AdminRootContext, collector.EditHandler, "collector/create.html", view_attrs=JSON_FORM_ATTRS)
]
